...
export const Topbar = () => {
  ...
  return (
    <>
      ...
      <div id="navbar-wrapper" className={`sticky top-0 z-10 border-b bg-base-100 lg:bg-opacity-95 lg:backdrop-blur-sm ${atTop?'border-transparent':'border-base-content/10'}`}>
